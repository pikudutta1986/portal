...
// DECLARING THE ResetpasswordComponent CLASS WITH EXPORT SO THAT WE CAN IMPORT THIS SERVICE INTO ANY OTHER COMPONENT OR SERVICE.
export class ResetpasswordComponent implements OnInit
{
  ...
  constructor
  (
    private formBuilder: FormBuilder, // TBD
    private router: Router, // TBD
  ) 
  { 
  }
